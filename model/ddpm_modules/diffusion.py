...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_loop(self, x_in, continous=False):
        sigma = 25.0
        marginal_prob_std_fn = partial(self.marginal_prob_std, sigma=sigma)  # 构建无参函数
        diffusion_coeff_fn = partial(self.diffusion_coeff, sigma=sigma)  # 构建无参函数
